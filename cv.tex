...
\vspace{-5pt}
\section{Summary}
Software Engineer with 14+ years experience in product-oriented companies. Can set up the development process or be included on ongoing, from scratch to release. Best motivated when see the impact on end users.
\vspace{-5pt}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        {from POC to production-ready service.}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        \resumeItemWithoutTitle{Implement new features and help to plan the team's half-year horizon roadmap.}
