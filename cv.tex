...
% TODO видимо нужно отдельно желаемый тайтл в самом верху запилить?
...
\resumeSubHeadingListStart
	...
	\resumeSubItem{Tools}{\tab\tab\tab\tab  FastAPI, Starlette, Flask, SQLAlchemy, Selenium, Pytest, Poetry, asyncio, websockets, lxml}
	\resumeSubItem{Data}{\tab\tab\tab\tab PostgreSQL, Redis, MySQL, MongoDB, Neo4j}
	\resumeSubItem{Infrastructure}{\tab Kubernetes, Helm, Docker, GCP, GitLab CI/CD, GitHub Actions}
\resumeSubHeadingListEnd
