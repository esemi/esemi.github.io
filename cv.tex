...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        {From POC to production-ready service with a live customers.}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        ...
        {Accelerated new integrations to our service.}
        \resumeItem{Implemented a new access distribution model for the corporate clients}
        ...
        {Made more clear how current integrations with 3rd-party tools could be built on.}
    \resumeItemListEnd
    ...
    \resumeItemListStart
        \resumeItem{Supported a change in the sales model for our SaaS}
...
\section{Projects}
    ...
    \resumeSubItem{Tax Calculator Tool (Investing, Taxes, CLI-tools)}{Utility for tax reporting based on Interactive Brokers LLC report for residents of the Czech Republic. Tech: Python, Pandas. (May '22)}
    \vspace{2pt}
    ...
    \resumeSubItem{Musicians Clustering (Crawlers, Music, Research)}{Research into the overlap of music styles on the Yandex.Music (Spotify-like service). Tech: Python, Selenium, lxml, Igraph (November '17)}
    \vspace{2pt}
...
\resumeSubHeadingListStart
	...
	\resumeSubItem{Tools}{\tab\tab\tab\tab FastAPI, Starlette, Flask, SQLAlchemy, Peewee, Pytest, Poetry}
	\resumeSubItem{Data}{\tab\tab\tab\tab Postgresql, Redis, Mysql, Mongodb, Neo4j}
	\resumeSubItem{Infrastructure}{\tab Kubernetes, Helm, Docker, GCP, Gitlab CI, Github Actions}
\resumeSubHeadingListEnd
